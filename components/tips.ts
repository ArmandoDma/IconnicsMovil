...
export const notifications = [
  {
    title: "Health Tip: Chia Pudding",
    content: "Fiber-rich. Mix chia with almond milk.",
    time: "Today"
  },
  {
    title: "Reminder: Hydration",
    content: "You’ve had 1 glass. Aim for 8.",
    time: "Today"
  },
  {
    title: "Health Tip: Avocado Toast",
    content: "Healthy fats. Mash avocado on toast.",
    time: "Yesterday"
  }
];